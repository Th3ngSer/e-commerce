...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::define('students.view', fn ($user) => $user->hasPermission('students.view'));
        Gate::define('students.create', fn ($user) => $user->hasPermission('students.create'));
        Gate::define('students.update', fn ($user) => $user->hasPermission('students.update'));
        Gate::define('students.delete', fn ($user) => $user->hasPermission('students.delete'));
    }
}
